...
# indexes = filter(lambda index: mdays[index] == 31, range(0, len(mdays)))
# name_indexes = map(lambda index: month_name[index], indexes)
# formated = reduce(lambda formated, month_name: formated +
#                   f'{month_name}\n', name_indexes, 'Meses com 31 dias:\n')
# print(formated)
